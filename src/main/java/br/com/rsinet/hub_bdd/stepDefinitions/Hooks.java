...
import br.com.rsinet.hub_bdd.extendReport.PrintScreen;
...
public class Hooks {
	...
	public void finalizaApp() {
		testContext.getDriverFactory().fecharApp();
	}
	
	@After(order = 1)
	public void ExtendReport(Scenario scenario) throws Exception {
		String caminho = PrintScreen.tirarPrints(testContext.getDriverFactory().iniciarApp(), scenario.getName());
